                    ...
                    <div id="switchPoint" class="e-panel card">
                        <div class="card-body">
                            <div class="card-title">
                                <h6 class="mr-2"><span>TRANSACTION HISTORY  FOR <b class="badge badge-success p-2 float-right"><?php echo strtoupper($customer->name)." ".strtoupper($customer->surname); ?></b> </span><small class="px-1"></small></h6>
                            </div>
                            <div class="e-table">
                                <div class="table-responsive table-lg mt-3">
                                    <table class="table table-bordered" id="myTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="max-width">TransactionTime</th>
                                        </tr>
                                        </thead>
                                        <tbody id="role">
                                        <?php
