 ...
 var cities = {
 	'Harare': ['Harare','Chitungwiza','Epworth','Harare Urban','Harare Rural'],
 	'Bulawayo': ['Bulawayo'],
 	'Masvingo': ['Bikita','Chiredzi','Chivi','Gutu','Masvingo','Mwenezi','Zaka'],
 	'Midlands': ['Chirumhanzu','Gokwe North','Gokwe South','Gweru','Kwekwe','Mberengwa','Shurugwi','Zvishavane','Rusape','Buhera','Chipinge Urban','Chipinge Rural','Makoni','Mutasa'],
 	'Mashonaland West': ['Chegutu','Chinhoyi','Hurungwe','Kariba','Makonde','Mhondoro-Ngezi','Sanyati','Zvimba'],
 	'Mashonaland Central': ['Bindura','Guruve','Mazowe','Mbire','Mount Darwin','Muzarabani'],
 	...
 	'Matebeleland North': ['Binga','Bubi','Hwange','Lupane','Nkayi','Tsholotsho','Umguza','Victoria Falls'],
 	'Manicaland': ['Buhera','Chimanimani','Chipinge','Makoni','Makoni','Mutasa','Mutare','Nyanga']
 }
 ...
 var City = function() {
	...
	this.showCities = function(province,element) {
		var str = '<option selected disabled>Select District</option>';
		var elem = '';
